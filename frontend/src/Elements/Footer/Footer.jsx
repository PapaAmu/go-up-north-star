    ...
    <footer className="bg-white text-gray-900 pt-16 pb-8 border-t border-gray-300">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-6 gap-4">
        ...
        <div className="md:col-span-1">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="#" className="hover:text-amber-500 hover:underline">Services</a></li>
            <li><a href="#" className="hover:text-amber-500 hover:underline">Contact</a></li>
          </ul>
        </div>
        ...
        <div className="md:col-span-1">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="#" className="hover:text-amber-500 hover:underline">Investing</a></li>
            <li><a href="#" className="hover:text-amber-500 hover:underline">Loans</a></li>
          </ul>
        </div>
        ...
        <div className="md:col-span-1">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="#" className="hover:text-amber-500 hover:underline">Support</a></li>
            <li><a href="#" className="hover:text-amber-500 hover:underline">Terms of Service</a></li>
          </ul>
        </div>
        ...
        <div className="md:col-span-1">
          ...
          <h4>123 Street, Location , Gauteng, Midrand 0000</h4>
           <div className="flex gap-4 text-lg pt-8">
            <a href="#" className="hover:text-amber-500 hover:underline"><FaFacebookF /></a>
            <a href="#" className="hover:text-amber-500 hover:underline"><FaTwitter /></a>
            <a href="#" className="hover:text-amber-500 hover:underline"><FaInstagram /></a>
          </div>
        </div>
      </div>
      ...
      <div className="border-t container border-gray-400 mt-12 pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500">
        ...
        <div className="flex gap-4">
          <a href="https://realnet-web.co.za/" target="_blank" className="hover:text-amber-500 text-gray-400 hover:underline">
            About Developers
          </a>
          <a href="#" className="hover:text-amber-500 text-gray-400 hover:underline"><FaFacebookF /></a>
          <a href="#" className="hover:text-amber-500 text-gray-400 hover:underline"><FaInstagram /></a>
        </div>
      </div>
    </footer>
    </div>
