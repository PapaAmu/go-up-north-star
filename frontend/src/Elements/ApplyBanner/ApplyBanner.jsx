      ...
      <div className="container">
        <section className="relative flex justify-center items-center py-20">
          ...
          <motion.div
            ...
            className="relative bg-gradient-to-r from-amber-600 to-amber-900 text-white rounded-3xl py-16 w-full text-center overflow-hidden shadow-lg"
          >
            {/* Left angled shape */}
            <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-48 h-36 bg-amber-500 rounded-lg rotate-[20deg] -ml-8"></div>

            {/* Right angled shape */}
            <div className="absolute right-0 top-1/2 transform -translate-y-1/2 w-48 h-36 bg-amber-700 rounded-lg rotate-[20deg] -mr-10"></div>
